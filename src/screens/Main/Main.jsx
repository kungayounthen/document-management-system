...
function Main() {
  ...
  return (
    ...
    <button className="capitalize p-2 shadow-md shadow-slate-100 bg-black rounded-md hover:bg-[#1565c0] text-white font-semibold active:shadow-none" onClick={()=>navigate('login')}>get started</button>
    </Box>
    </Box>
    )
}
